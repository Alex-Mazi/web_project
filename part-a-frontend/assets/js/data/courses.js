window.courses = [
  ...
  },
  {
    ...
    category: "Programming",
    level: "Beginner",
    description: "A hands-on introduction to HTML, CSS, and JavaScript to help you build modern, responsive websites.",
    recommended: true,
  ...
  },
  {
    ...
    category: "Networks",
    level: "Intermediate",
    description: "Learn how to configure networks, secure communication, manage traffic, and protect infrastructure from common vulnerabilities.",
    recommended: true,
  ...
  /* -------------------- DATABASES -------------------- */
  {
    ...
    category: "Databases",
    level: "Beginner",
    description: "Master database concepts, relational models, and practical SQL queries for storing and retrieving information.",
    recommended: true,
